...
(function() {
	...
	Game_CardBattle.prototype.getMessage = function() {
		if (this._messages.length > 0) {
			...
			this._playerDeck.setDrawNumber(message.playerHp, message.playerAtk,message.playerPow); //ここにpowを追加。
			this._enemyDeck.setDrawNumber(message.enemyHp, message.enemyAtk,message.enemyPow);
	...
	Game_Deck.prototype.setDrawNumber = function(hpDraw, atkDraw, powDraw) { //第3パラメータに powDrawを追加
