//=============================================================================
// ROW_ShopItemPicture_Debug.js
// ショップで選択中のアイテムに応じてピクチャを表示するプラグイン（デバッグ版）
//=============================================================================

/*:
 * @plugindesc ショップで選択中のアイテムに応じてピクチャを表示（デバッグ出力付き）。画像は img/pictures に配置してください。
 * @author Rowkoc
 *
 * @param PictureId
...
(function() {
    const parameters = PluginManager.parameters('ROW_ShopItemPicture_Debug');
    ...
    Window_ShopBuy.prototype.updateHelp = function() {
        ...
        if (picName) {
            console.log(`[ShopPicture] Showing picture '${picName}' at (${posX}, ${posY})`);
